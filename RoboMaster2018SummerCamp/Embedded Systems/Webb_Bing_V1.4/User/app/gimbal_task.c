...
void get_gimbal_information(void)
{
  ...
  //云台相对角度获取
  yaw_relative_angle =  get_relative_pos(w_2006_moto_ID_5_plus[0].ecd, yaw_center_offset)/22.75f;
  pit_relative_angle = -get_relative_pos(w_2006_moto_ID_5_plus[1].ecd, pit_center_offset)/22.75f;
...
void shoot_task(void)
{
  ...
  /* bullet single or continue trigger command control  */
  {
    ...
    {
      trigger_moto_position_ref = w_2006_moto_ID_5_plus[2].total_ecd;
    }
